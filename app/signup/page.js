...
function SignUpForm() {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      if (data.user && data.user.identities && data.user.identities.length === 0) {
        setError('Email ini sudah terdaftar tapi belum diverifikasi. Cek email Anda untuk konfirmasi.');
      } else if (data.user) {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      // Google akan redirect otomatis, jadi kita tidak perlu melakukan apa-apa di sini
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-2 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400">Atau daftar dengan email</span>
        </div>
      </div>
